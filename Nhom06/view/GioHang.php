...
<body>
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td><a href="?h=ChiTietSanPham&id=<?php echo $value['ID_SP'] ?>"><h4>Xem chi tiết</h4></a></td>
            <td><a href="?h=XoaKhoiGioHang&id=<?php echo $value['ID_SP'] ?>"><h4>Xóa khỏi giỏ hàng</h4></a></td>
            <?php
                }
            }
            ?>
        ...
        <tr style="background: linear-gradient(to right, #26D0CE, #1A2980)">
            ...
            <td><a href="?h=XoaKhoiGioHangAll&id=<?php echo $value['ID_SP'] ?>"><h4>Xóa tất cả</h4></a></td>
            <td></td>
        </tr>
    ...
    <div style="margin-left:300px;">
        ...
        <a href="?h=Bill&id=<?php echo $value['ID_SP'] ?>">
            <button class="add-list" fdprocessedid="3bnd6k">
